    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form id="product_form" action="{{ route('products.product.store') }}" method="post">
                    @csrf
...
<script>
  ...
  <script>
        ...
        $("input[name='product_code']").change(function(event) {

            $.ajax({
                type : "GET",
                url : "{{ route('products.product_code_verification') }}",
                data : "product_code="+$(this).val(),
                success : function (response) {
                    $("#product_code_error").html(response);
                }
            })

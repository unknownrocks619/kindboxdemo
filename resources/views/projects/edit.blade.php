    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form id="new_org" action="{{ route('organiser.project.update',$project->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$project->project_title}}" name="project_name" id="project_name" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="category" id="category" class="form-control">
                                            @foreach ($cats as $cat)
                                                <option value="{{$cat->id}}" @if($project->category_id == $cat->id) selected @endif> {{ $cat->category }} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="organisor" id="orgs" class="form-control">
                                            @foreach ($orgs as $org)
                                                <option @if($org->id == $project->organiser_id) selected @endif value="{{$org->id}}">{{ $org->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        @if($project->featured_image)
                                            <img src="{{ asset ($project->uploaded_image->path) }}" class="text-center img-thumbnail" style="width: 95px;height:95px;" alt="">
                                        @endif
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="url" value="{{ $project->map_link }}" class="form-control" name="map_link" id="map_link" />
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="map_embed" class="form-control" id="google_map_embed" >{{$project->map_embed}}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="project_budget" value="{{ $project->total_budget }}" class="form-control" />
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="country" value="{{ $project->country }}" id="country" class="form-control" />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" id="city" value="{{ $project->city }}" class="form-control" />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" id="address" value="{{ $project->address }}" class='form-control' />
